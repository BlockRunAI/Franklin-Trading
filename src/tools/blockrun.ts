 ...
 *
 * One tool, every BlockRun endpoint. Skills in
 ...
 * future ML/data partners). Hardcoding each as a fresh CapabilityHandler
 * means a Franklin Trading npm release per partner and a bigger tool list
 * for the LLM to reason about. This primitive plus markdown skill files
 * decouples API expansion from agent releases — new partners ship as a
 * new SKILL.md, no code change.
 */
