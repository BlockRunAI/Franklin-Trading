...
> <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models, removable-by-design harness components)
...
| Auto model routing on the shared Router Core engine, <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models, dead-model kill-switch | ✅ shipped | `src/router/` |
...
The full catalog — <!-- br:models.totalVisible -->104<!-- /br:models.totalVisible --> visible models including image, video, music and speech — is at
